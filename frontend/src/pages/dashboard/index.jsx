...
function dashBoard() {
  ...
  const handleUpload = async () => {
    await dispatch(createdPost({ file: fileContent, body: postContent }));
    setPostContent("");
    setFileContent(null);
            ...
            <div className={styles.wraper}>
              <div className={styles.createPostContainer}>
                ...
                <textarea
                  ...
                  placeholder="What's in your mind" className={styles.textAreaContant} name='' id=''></textarea>
              ...
              <div className={styles.postConatiner}>
                {postState.postFetch && postState.posts.map((post, indx) => {
                  return (
                        ...
                        <div>
                          <div style={{ display: "flex", gap: "1.2rem", justifyContent: "space-between" }}>
                            ...
                            <div onClick={() => {
                              ...
                              handleDeleltePost(post._id)
                            }}>
                              {post.userId._id === authState.user.userId._id && <svg style={{ height: "1.4em", color: "red", cursor: "pointer", }} xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="size-6">
                          ...
                          <div className={styles.optionsContainer}>
                            ...
                            <div
                              onClick={() => {
                                ...
                                const url = encodeURIComponent("apnaollege.in");
          ...
          </div>
          {
            ...
            <div
              ...
              <div
                ...
                <div>
                  {postState.comments.map((postComment,indx)=>{
                    return (
                      <div key={indx} className={styles.singleComment}>
                        ...
                        <div>
                          <p style={{marginTop:"0.3rem"}}>{postComment.comment}</p>
                        </div>
                ...
                <div className={styles.postCommentContainer}>
                  <input placeholder='Comment'  type="text" value={commentText} onChange={(e)=>setCommentText(e.target.value)}/>
                  <div
                  onClick={async()=>{
